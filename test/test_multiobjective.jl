# let
	...
	@test isapprox(xs[5], atan(0,4), atol=1e-6)
	@test isapprox(xs[4], atan(1,3), atol=1e-6)
	@test isapprox(xs[3], atan(2,2), atol=1e-6)
	@test isapprox(xs[2], atan(3,1), atol=1e-6)
	@test isapprox(xs[1], atan(4,0), atol=1e-6)
